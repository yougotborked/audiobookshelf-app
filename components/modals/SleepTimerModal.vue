    ...
    <div class="px-4 pt-2 pb-2">
      ...
      <div class="w-full overflow-x-hidden overflow-y-auto" style="max-height: 60vh">
        ...
        <ul v-else-if="!sleepTimerRunning" class="w-full" role="listbox" aria-labelledby="listbox-label">
          ...
          <li v-if="currentEndOfChapterTime" class="text-md-on-surface select-none relative py-4 rounded-md-sm hover:bg-md-on-surface/5" role="option" @click="clickedChapterOption(timeout)">
            <div class="flex items-center justify-center">
